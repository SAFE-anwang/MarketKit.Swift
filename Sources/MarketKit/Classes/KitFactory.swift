...
extension Kit {
    ...
    public static func instance(hsApiBaseUrl: String, cryptoCompareApiKey: String? = nil, hsProviderApiKey: String? = nil, minLogLevel: Logger.Level = .error, isSafe4Test: Bool = false) throws -> Kit {
        isSafe4TestNet = isSafe4Test
